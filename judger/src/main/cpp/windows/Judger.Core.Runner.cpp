 ...
 */
JNIEXPORT jobject JNICALL Java_com_kingdee_exam_judger_core_Runner_getRuntimeResult(
...
std::string getErrorMessage(const std::string& apiName) {
    ...
    stringStream << "API:     " << apiName << std::endl
                 ...
                 << "Message: " << string_To_UTF8(errorMessage) << std::endl;
